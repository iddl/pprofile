  ...
  var CompositeDisposable, LauncherView, PyLprof, StatsViewer, StatusView, _, fs, path, pprofile, statsViewer;
  ...
  pprofile = {
    ...
    run: function(cmd) {
      var editor, filename, runner, self, stre;
      self = this;
