  ...
  var StatsViewer, _, extent, scaleLinear;
  ...
  StatsViewer = (function() {
    ...
    StatsViewer.prototype.renderWidthMarker = function(widestText) {
      var gutterDom, markerClass, widthMarker;
    ...
    StatsViewer.prototype.addMarkers = function(editor, stats) {
      var colorField, colorScale, formatter, self, widestText;
      stats = stats || {};
      self = this;
